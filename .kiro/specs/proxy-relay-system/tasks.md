...
- [x] 3. 实现sing-box配置生成和管理
  - [x] 3.1 实现ProxyManager基础类
    - 创建ProxyManager类框架
    - 实现初始化方法
    - _需求: 1.1, 2.1_

  - [x] 3.2 实现sing-box配置生成
...
- [x] 9. 实现API客户端 (APIClient)
  - [x] 9.1 创建API客户端基础类
    - 实现APIClient类框架
    - 支持配置多个API提供商
    - _需求: 6.1_

  - [x] 9.2 实现91HTTP API集成
    - 实现get_new_proxy()方法
    - 构建查询参数
    - 发送HTTP GET请求
    - _需求: 6.2_
